...
class _LockScreenState extends State<LockScreen>
  ...
  bool _checking = false; // true while verifyPin is in flight
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      // Biometric key — shown only when available
                      _bioAvailable
                          ? _IconKey(
...
class _DigitKey extends StatelessWidget {
  ...
  final AppColors c;
  const _DigitKey(
      {required this.digit, required this.onTap, required this.c});
...
class _EmptyKey extends StatelessWidget {
  final AppColors c;
  const _EmptyKey({required this.c});

  @override
  Widget build(BuildContext context) =>
      SizedBox(width: 80, height: 72); // spacer to keep grid aligned
}
